    ...
    <View className="flex-1 bg-white" style={{backgroundColor:themeColors.bg}}>
        ...
        <View className="flex-1 bg-white px-8 pt-8" style={{borderTopLeftRadius:50, borderTopRightRadius:50}}>
          <View className="form space-y-2">
            ...
            <TextInput className="p-4 bg-gray-100 text-gray-700 rounded-2xl" secureTextEntry value={password} onChangeText={pass => setPassword(pass)} placeholder='Enter Password'/>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
            <Text className="font-semibold text-yellow-500">Sing Up</Text>
        </TouchableOpacity>
    </View>
        </View>
    </View>
